...
function loadStatsPage(){
	...
	var winsLoss = document.getElementById("wins/losses");
	var row_counter;
	var col_counter;
...
*/
	...
	function loadPlayersPage()
	{
		...
		{
			otherPlayer=otherPlayer + "<a class= 'dropdown-item' href ='#' onclick = 'switchPlayers("+i+")' >"+players[i].name+"</a>"
		}
		player.innerHTML=otherPlayer;
	}
